 ...
 * {@link #setViewPager(ViewPager)} providing it the ViewPager this file_chooser_layout is
 * being used for.
 * <p>
 ...
 * {@link #setCustomTabView(int, int)}, providing the file_chooser_layout ID of your custom
 * file_chooser_layout.
 */
@SuppressLint("InlinedApi")
public class SlidingTabLayout extends HorizontalScrollView {
	/**
	 * Allows complete control over the colors drawn in the tab file_chooser_layout. Set with
	 ...
	 * that the file_chooser_layout can update it's scroll position correctly.
	 *
	...
	/**
	 * Set the custom file_chooser_layout to be inflated for the tab views.
	 *
	 * @param layoutResId
